...
class FranchiseeController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $validated = $request->validate([
            ...
            'siret_number' => 'required|string|size:14|unique:franchisees,siret_number',
    ...
    public function update(Request $request, $id) {
        ...
        $validated = $request->validate([
            ...
            'siret_number' => 'sometimes|string|size:14|unique:franchisees,siret_number,' . $id,
        ...
        return response()->json($franchisee, 200);
